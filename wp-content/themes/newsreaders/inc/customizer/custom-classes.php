...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Newsreaders_Custom_Radio_Image_Control extends WP_Customize_Control {
...
// Radio COlor Schema
class Newsreaders_Custom_Radio_Color_Schema extends WP_Customize_Control {
 ...
 * @access public
 */
class Newsreaders_Customize_Section_Upsell extends WP_Customize_Section {
